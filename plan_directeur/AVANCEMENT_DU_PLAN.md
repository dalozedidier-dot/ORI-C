...
- **Wong & Seguin 2015 — acquisition et analyse compatible terminées** : l'archive Dryad complète a été conservée avec ses cinq fichiers et leurs empreintes vérifiées. Une table réelle appariant 46 populations évoluées à leur progéniteur a été construite. Dans une analyse rétrospective explicitement post hoc, la mutation fondatrice n'améliore pas la prédiction de la MIC finale au-delà de la MIC et du gène du progéniteur (gain −5,69 %, IC bootstrap [−16,82 ; 2,78], permutation stratifiée p = 0,578). Ce résultat négatif ne modifie ni PRED-VIVANT-HISTOIRE-001 ni le §XIV.
...
- **Pipeline commun achevé** : le bundle commun produit désormais automatiquement la matrice par branche, les preuves associées, l'état INV-A et l'entrée machine du §XIV. La chaîne de réplication vivante documente successivement Wong–Seguin, Santos-Lopez, Card et la route prospective LTEE sans attribuer de crédit à une analyse rétrospective.
