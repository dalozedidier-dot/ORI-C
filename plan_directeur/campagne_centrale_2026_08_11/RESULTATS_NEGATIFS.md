# Résultats négatifs et non concluants

Ces résultats sont conservés ; ils ne doivent pas être relancés uniquement pour
obtenir un verdict positif.

| Objet | Verdict | Résultat décisif | Suite autorisée |
|---|---|---|---|
| M2 climat | réfuté sous les critères testés | 1/10 et perte contre témoins appariés | clôturer `CLOSED_NEGATIVE`; exécuter seulement un protocole distinct déjà gelé |
| Carte relationnelle | réfutée | la structure ne bat pas clairement la chronologie | nouveau test seulement avec hypothèse différente préenregistrée |
