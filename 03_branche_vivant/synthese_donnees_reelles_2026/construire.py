...
def main() -> None:
    ...
    rows = [
        {
            "study": "D'Onofrio", "stratum": "all", "independent_unit": "strain/lineage group", "X": "present limitation", "H_or_m": "ancestral limitation history", "Theta": "antibiotic assay", "future_R": "MIC", "n_independent_units": don["group_count"], "effect": don["history_gain_percent"], "effect_unit": "RMSE gain percent X vs X+H", "uncertainty_interval": "not reported in legacy artifact", "permutation_p": don["permutation_p_history_better_than_shuffled"], "verdict": "positive_real_retrospective"
        },
        {
            "study": "Card 2019", "stratum": "Ara+5 tetracycline", "independent_unit": "held-out strain block", "X": "present parent MIC", "H_or_m": "temporal strain identity", "Theta": "tetracycline assay", "future_R": "daughter MIC", "n_independent_units": 4, "effect": card["history_gain_vs_state_percent"], "effect_unit": "RMSE gain percent X vs X+H", "uncertainty_interval": json.dumps(card["group_bootstrap"]["difference_history_minus_state_rmse_ci95"]), "permutation_p": None, "verdict": "negative_history_model_worse"
        },
        {
            "study": "Wong & Seguin 2015", "stratum": "ciprofloxacin", "independent_unit": "evolved population", "X": "progenitor MIC and target gene", "H_or_m": "founding resistance mutation", "Theta": "ciprofloxacin evolution", "future_R": "endpoint MIC", "n_independent_units": wong["mapping"]["n_independent_units"], "effect": wong["results"]["history_gain_percent"], "effect_unit": "RMSE gain percent X vs X+m", "uncertainty_interval": json.dumps([wong["results"]["bootstrap_gain_q025_percent"], wong["results"]["bootstrap_gain_q975_percent"]]), "permutation_p": wong["results"]["permutation_p_one_sided"], "verdict": "negative_no_incremental_information"
        },
        {
            "study": "Lamrabet 2019", "stratum": "15 antibiotics", "independent_unit": "LTEE lineage", "X": "MIC profile at generation 2000", "H_or_m": "lineage realized history", "Theta": "antibiotic-specific MIC assay", "future_R": "MIC profile at generation 50000", "n_independent_units": lam["n_independent_units"], "effect": lam["global"]["spearman_profile_persistence"], "effect_unit": "Spearman persistence", "uncertainty_interval": json.dumps([lam["global"]["bootstrap_q025"], lam["global"]["bootstrap_q975"]]), "permutation_p": lam["global"]["permutation_p_two_sided"], "verdict": "divergence_real_persistence_not_significant_at_0.05"
        },
    ]
    for antibiotic, value in pet["phenotype_by_antibiotic"].items():
        ...
        rows.append({
            "study": "Petrungaro 2026", "stratum": antibiotic, "independent_unit": "evolved plate-well population", "X": "initial IC50", "H_or_m": "initial gene-deletion background", "Theta": antibiotic, "future_R": "endpoint IC50", "n_independent_units": value["n_populations"], "effect": value["relative_gain_percent"], "effect_unit": "RMSE gain percent X vs X+m", "uncertainty_interval": json.dumps([value["bootstrap_gain_q025_percent"], value["bootstrap_gain_q975_percent"]]), "permutation_p": value["background_permutation_p_one_sided"], "verdict": "positive_robust_real_retrospective" if robust else "not_robust_bootstrap_crosses_zero"
        })
    rows.append({
        "study": "Nader AVT", "stratum": "2:1 decanoic acid:decanol", "independent_unit": "independent batch unavailable; particles are nested", "X": "physical formulation", "H_or_m": "not manipulated", "Theta": "aerosol-to-landing transformation", "future_R": "chromatography and particle size", "n_independent_units": None, "effect": nad["observed_particle_sizes"]["median_nm"], "effect_unit": "observed median particle size nm", "uncertainty_interval": json.dumps([nad["observed_particle_sizes"]["q025_nm"], nad["observed_particle_sizes"]["q975_nm"]]), "permutation_p": None, "verdict": "physical_characterisation_not_history_test"
    })
