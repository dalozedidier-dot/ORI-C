...
`lignees_vesicules/` utilise les douze classeurs expérimentaux intégrés et reconstruit les filiations à partir des cartes donneur-receveur. Le test sépare réponse à la sélection, signal parent-descendant, permutation de la filiation et ablation du mécanisme.
