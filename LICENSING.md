...
Ce choix peut être remplacé dans une version ultérieure par des licences séparées pour le code, les textes, les figures et les données produites par ORI-C. Un tel changement devra être explicite et ne sera pas rétroactif par défaut.
