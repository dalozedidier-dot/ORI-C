...
| `C-GC-E05` | extension_empirique_non_preregistered | supports_observed_cloud_to_disk_supply | direct_astronomical_observation — Observation d’un autre système protostellaire; démontre l’existence physique du canal d’apport sans reconstruire l’histoire particulière du Soleil. |
...
| `C-GC-E07` | extension_empirique_non_preregistered | supports_observed_refractory_solid_formation | direct_astronomical_observation — HOPS-315 est un analogue astrophysique observé; la comparaison à des modèles de condensation publiée dans l’article n’est pas utilisée comme donnée de cette campagne. |
