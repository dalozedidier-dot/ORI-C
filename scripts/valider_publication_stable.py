...
for needle in ['7,02 Ma','1 critère sur 10','tolérance','3 fenêtres sur 3','Trajectoires réelles','31 nœuds','H011','MESA','11 760','0,00050','1,1309','0,8042','0,00498']:
    if needle not in proof+repro: errors.append(f'page publique incomplète: {needle}')
current_text = '\n'.join([
    (ROOT/'README.md').read_text(),
    (ROOT/'ETAT_DES_PREUVES.md').read_text(),
    proof,
])
for stale in [
