...
Dans la branche astronomique, le prochain travail ne consiste pas à « ajouter Uranus et Neptune » : elles sont déjà présentes dans le témoin à huit planètes. La priorité est de tester la spécificité des effets de Jupiter/Saturne par interventions symétriques sur Uranus/Neptune, d'extraire les modes séculaires `g_i/s_i`, puis de préparer un module spin-orbite Terre-Lune. Cette extension reste à l'intérieur du livrable Système solaire et ne crée aucun nouveau domaine.
