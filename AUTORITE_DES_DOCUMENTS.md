...
## Publication stable 0.9.5-research

`PUBLICATION_STABLE.md` fixe la procédure de publication du snapshot du 10 août 2026. `RELEASE_NOTES_v0.9.5-research.md` décrit ce snapshot mais ne prime jamais sur les sorties machine. La publication doit conserver simultanément les résultats positifs et les résultats négatifs, notamment **13/15** pour la couche astronomique et **1/10** pour M2.
