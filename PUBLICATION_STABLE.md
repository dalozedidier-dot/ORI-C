# Publication stable v0.9.6-research
...
`.zenodo.json` est synchronisé sur `0.9.6-research`. L’obtention d’un DOI exige l’activation de l’intégration GitHub dans Zenodo et la publication effective de la release. Aucun DOI n’est inscrit tant qu’il n’existe pas.
