...
- À l’archive angritique, t = 1.10 ± 0.19 Myr après le repère CAI, il reste 34.5% de l’inventaire initial de 26Al.
- À EC 002, t = 1.74 ± 0.20 Myr: 18.6% reste.
- Au chondre le plus jeune sélectionné, t = 2.59 ± 0.34 Myr: 8.2% reste.
- À l’événement carbonate CM, t = 3.90 ± 0.52 Myr: 2.3% reste.
...
- Les météorites de fer IIAB/IIIAB/IVA placent la formation des noyaux vers 1.0–1.5 Myr après CAI. À cet intervalle, le calcul déterministe donne 23.5–38.0% de l’inventaire initial encore présent.
- Cette fenêtre contient environ 2.9–4.7 fois plus de 26Al que l’époque du chondre le plus jeune du test.

## 3. Une architecture isotopique persiste pendant que l’inventaire énergétique s’effondre

- La séparation NC/CC publiée persiste au minimum 2–3 Myr, soit 2.79–4.18 demi-vies de 26Al.
- Entre le début et la fin de cette fenêtre, l’inventaire relatif de 26Al diminue d’un facteur 6.9–18.2.

### Contrôle post-hoc — le temps ne fixe pas seul l’inventaire local

- À ~2 Myr, la référence canonique de décroissance seule vaut 7.565e-06.
- Le premier CAI à matériel chondritique mesure 4.70e-06, soit 62.1% de cette référence.
- Le second est <1.20e-06, soit <15.9% de la référence.
- Une autre archive du corpus rapporte indépendamment une hétérogénéité 26Al d’un facteur 3–4.
...
- Les grains présolaires mesurés dans Bennu, Ryugu et Wild 2 imposent une borne conservatrice de persistance matérielle >4.567 Gyr.
- Ryugu enregistre une réactivation fluide >1000 Myr après formation, soit >1395 demi-vies de 26Al; la cause tardive reste non identifiée ici.
...
- Verdict ORI-C sur la provenance terrestre: `empirically_contested_not_closed`.

## 6. Endpoint mesuré et verrou de reconstruction

- Les 8 corps de l’endpoint JPL couvrent un facteur 77.68 en demi-grand axe (Mercure → Neptune) dans la table utilisée.
- Chaîne stricte produits stellaires → endpoint actuel: true.
- Chaîne stricte baseline primordiale → endpoint actuel: false.
- Nœuds critiques de la chaîne stricte: GC-E02, GC-E03, GC-E08, GC-E10, GC-E13, GC-E17.
