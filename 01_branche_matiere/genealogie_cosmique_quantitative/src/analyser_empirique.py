...
def evaluate_claims(measurements, derived, source_ids):
    ...
    add('C-GC-E14','Des planètes du Système solaire portent-elles aujourd’hui des histoires d’accrétion différentes mesurables ?',
        'supports_planet_specific_accretion_histories',['GC-E17','GC-E18','GC-E19'],['S026','S027','S028','S042','S043'],
        'present_planets_retain_isotopic_constraints_on_distinct_growth_histories','planetary_isotope_reconstruction_plus_observed_endpoint','Mars conserve une contrainte temporelle Hf-W-Th et la Terre plusieurs contraintes Mo. Les reconstructions de provenance terrestre sont désormais explicitement contradictoires: ORI-C conserve ce conflit au lieu de choisir une histoire. Les scénarios orbitaux restent exclus.',
        {'Mars_half_size_time_upper_myr':v['Mars_half_size_time_upper'],'Earth_2019_Mo_CC_late_addition_supported':bool(v['Earth_Mo_between_NC_CC']),'Earth_2025_late_stage_NC_dominated':bool(v['Earth_late_stage_NC_dominated']),'Earth_provenance_status':'empirically_contested','BSE_epsilon94Mo_latest':v['BSE_epsilon94Mo_latest'],'BSE_epsilon95Mo_latest':v['BSE_epsilon95Mo_latest'],'present_planets':v['Solar_System_planets']})
