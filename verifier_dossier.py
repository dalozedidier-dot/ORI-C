...
STRUCTURE_ATTENDUE = [
    ...
    "ENVIRONNEMENT.md",
    "methodologie_puissance/README.md",
    "methodologie_puissance/power_monte_carlo.py",
    "methodologie_puissance/schema_power_plan.json",
    ...
    "01_branche_matiere/hypergraphe_transformations/calibrage_v094",
    "01_branche_matiere/hypergraphe_transformations/calibrage_v094/resultats/SYNTHESE_CALIBRAGE.json",
    "01_branche_matiere/hypergraphe_transformations/calibrage_v094/resultats/RAPPORT_CALIBRAGE.md",
    "protocoles_geles/v0.9.3_architecture_matiere/FROZEN.json",
